 ...
 * الصقري للاتصالات - Phone Store Management System with Firebase
 */
...
class FirebaseStorageManager {
    constructor() {
        ...
        this.isFirebaseAvailable = !!(this.firebaseStorage && this.firebaseAuth);
    ...
    async getPhones() {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.getPhones();
            } catch (error) {
    ...
    async setPhones(phones) {
        if (this.isFirebaseAvailable) {
            // For Firebase, we don't set all phones at once, we add/update individually
    ...
    async addPhone(phone) {
        if (this.isFirebaseAvailable) {
            try {
                ...
                const phoneId = await this.firebaseStorage.addPhone(phone);
                return phoneId;
            } catch (error) {
    ...
    async updatePhone(phoneId, updatedPhone) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.updatePhone(phoneId, updatedPhone);
                return true;
            } catch (error) {
    ...
    async deletePhone(phoneId) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.deletePhone(phoneId);
                return true;
            } catch (error) {
    ...
    async getAccessories() {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.getAccessories();
            } catch (error) {
    ...
    async addAccessory(accessory) {
        if (this.isFirebaseAvailable) {
            try {
                ...
                const accessoryId = await this.firebaseStorage.addAccessory(accessory);
                return accessoryId;
            } catch (error) {
    ...
    async updateAccessory(accessoryId, updatedAccessory) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.updateAccessory(accessoryId, updatedAccessory);
                return true;
            } catch (error) {
    ...
    async deleteAccessory(accessoryId) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.deleteAccessory(accessoryId);
                return true;
            } catch (error) {
    ...
    async getSales() {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.getSales();
            } catch (error) {
    ...
    async addSale(sale) {
        if (this.isFirebaseAvailable) {
            try {
                ...
                const saleId = await this.firebaseStorage.addSale(sale);
                return saleId;
            } catch (error) {
    ...
    async updateSale(saleId, updatedSale) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.updateSale(saleId, updatedSale);
                return true;
            } catch (error) {
    ...
    async deleteSale(saleId) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.deleteSale(saleId);
                return true;
            } catch (error) {
    ...
    async getSaleById(saleId) {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.getSale(saleId);
            } catch (error) {
    ...
    async getPhoneTypes() {
        if (this.isFirebaseAvailable) {
            try {
                const phoneTypes = await this.firebaseStorage.getPhoneTypes();
                // Convert array to object format for compatibility
                const phoneTypesObj = {};
                phoneTypes.forEach(type => {
                    if (!phoneTypesObj[type.brand]) {
                        phoneTypesObj[type.brand] = [];
                    }
                    phoneTypesObj[type.brand].push(type.model);
                });
                return phoneTypesObj;
            } catch (error) {
                console.error('Error getting phone types from Firebase:', error);
    ...
    async addPhoneType(brand, model) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.addPhoneType({ brand, model });
                return true;
            } catch (error) {
    ...
    async deletePhoneType(brand, model) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.deletePhoneType(brand, model);
                return true;
            } catch (error) {
    ...
    async getAccessoryCategories() {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.getAccessoryCategories();
            } catch (error) {
    ...
    async addAccessoryCategory(category) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.addAccessoryCategory(category);
                return true;
            } catch (error) {
    ...
    async deleteAccessoryCategory(categoryName) {
        if (this.isFirebaseAvailable) {
            try {
                await this.firebaseStorage.deleteAccessoryCategory(categoryName);
                return true;
            } catch (error) {
    ...
    async searchPhones(searchTerm) {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.searchPhones(searchTerm);
            } catch (error) {
    ...
    async searchAccessories(searchTerm) {
        if (this.isFirebaseAvailable) {
            try {
                return await this.firebaseStorage.searchAccessories(searchTerm);
            } catch (error) {
    ...
    onPhonesChange(callback) {
        if (this.isFirebaseAvailable) {
            return this.firebaseStorage.onPhonesChange(callback);
        }
    ...
    onAccessoriesChange(callback) {
        if (this.isFirebaseAvailable) {
            return this.firebaseStorage.onAccessoriesChange(callback);
        }
        console.log('Real-time listeners only available with Firebase');
        return null;
    }
    ...
    onSalesChange(callback) {
        if (this.isFirebaseAvailable) {
            return this.firebaseStorage.onSalesChange(callback);
        }
        console.log('Real-time listeners only available with Firebase');
        return null;
    }
